...
helm.sh/chart: {{ include "okdp-server.chart" . }}
...
*/}}
{{- define "okdp-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "okdp-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
